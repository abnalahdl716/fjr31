...
import { LogOut, User, ShieldCheck, Cloud, Wifi } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-base sm:text-lg font-extrabold text-emerald-950 tracking-tight">
                  {settings.orgName}
                </h1>
                ...
                <div
                  title="المزامنة السحابية الحية (Firebase Cloud)"
                ...
                >
                  ...
                  <span className="hidden md:inline">سحابي حي</span>
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                </div>
              </div>
              <p className="text-xs text-slate-500 hidden md:block">
                تتبع الحضور بنظام GPS • إدارة الإجازات • حساب التأخير بالثواني • مزامنة سحابية
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-2">
                ...
                {onSwitchAccount && (
                  <button
                    ...
                    className="hidden sm:flex items-center justify-center p-2 rounded-xl text-slate-600 hover:bg-slate-100 border border-slate-200 transition-colors text-xs font-medium cursor-pointer"
                  >
                    تبديل
                  </button>
                )}
